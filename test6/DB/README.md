...
|字段|类型|主键、外键|可以为空|默认值|约束|说明|
|:---|:---|:---|:---|:---|:---|:---|
|course_major_id|NUMBER(12,0)|主键|否| | |课程专业关联id|
|course_id|NUMBER(12,0)|外键|否| | |课程id|
|major_id|NUMBER(10,0)|外键|否| | |专业id|
...
|course_id|NUMBER(12,0)|外键|否| | |课程id|
|test_url|VARCHAR(256BYTE)| |否| | |实验说明githuburl|
...
|total_score_id|NUMBER(6,0)|联合主键、外键|否| | |总评分id，实验总分表外键|
...
|字段|类型|主键、外键|可以为空|默认值|约束|说明|
|:---|:---|:---|:---|:---|:---|:---|
|total_score_id|NUMBER(6,0)|外键|否| | |总评分id|
